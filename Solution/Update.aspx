<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Update.aspx.cs" Inherits="Solution_Update" %>
...
<asp:Content ContentPlaceHolderID="main" runat="Server">
    <Moo:LinkBar runat="server" Title="题解">
        <Moo:LinkBarItem URL='<%#"~/Solution/?revision="+revision.ID %>' Text="题解" />
        <Moo:LinkBarItem URL='<%#"~/Solution/Update.aspx?revision="+revision.ID %>' Selected="true"
            Text="更新" />
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RegularExpressionValidator runat="server" ControlToValidate="txtReason" Display="Dynamic"
                    ValidationExpression=".{1,40}" CssClass="validator">长度需在1~40之间</asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr>
            <th>
