<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="History.aspx.cs" Inherits="Problem_History" %>
...
<asp:Content ContentPlaceHolderID="main" runat="Server">
    <Moo:LinkBar ID="linkbar" runat="server" Title="题目">
        ...
        <Moo:LinkBarItem URL='<%#"~/Problem/History.aspx?id="+problem.ID %>' Selected="true"
            Text="历史" />
    ...
    <Moo:InfoBlock ID="infoDeletingLatest" runat="server" Type="Error" Visible="false"
        ViewStateMode="Disabled">
        不能删除最新版本。
    </Moo:InfoBlock>
    
    <asp:EntityDataSource ID="dataSource" runat="server" ConnectionString="name=MooDB"
        DefaultContainerName="MooDB" EntitySetName="ProblemRevisions" OrderBy="it.[ID] DESC"
        Include="CreatedBy,Problem" Where="it.[Problem].[ID]=@problemID" EnableDelete="True">
        <WhereParameters>
    ...
    <asp:GridView ID="grid" runat="server" AllowPaging="True" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="内容">
                <ItemTemplate>
                    <a href='<%#"~/Problem/?revision="+Eval("ID") %>' runat="server">
